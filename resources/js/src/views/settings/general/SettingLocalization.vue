    ...
    >
        <b-card>
            <b-row>
                ...
                <b-col md="6">
                    <b-form-group :label="$t('app_setting_timezone')" label-for="app_setting_date_format">
                        <v-select
                            ...
                            :options="timezones"
                            :clearable="false"
                            :placeholder="$t('app_setting_timezone_placeholder')"
                        />
                    </b-form-group>
                </b-col>
                ...
                <b-col md="6">
                    <b-form-group :label="$t('app_setting_is_human_date_format')" label-for="app_setting_is_human_date_format">
                        <b-form-checkbox id="app_setting_is_human_date_format" v-model="config.enable_human_date_format" name="app_setting_is_human_date_format">
