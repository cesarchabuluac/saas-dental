    ...
    >
        <b-card>
            <b-row>
                ...
                <b-col md="6">
                    ...
                    >
                        <b-form-input
                            ...
                            :placeholder="
                                $t('app_setting_app_name_placeholder')
                            "
                        />
                    </b-form-group>
                </b-col>
                ...
                <b-col md="6">
                    <b-form-group
                        :label="$t('app_setting_app_short_description')"
                        label-for="app_short_description"
                        :description="
                            $t('app_setting_app_short_description_help')
                        "
                    >
                        <b-form-input
                            v-model="config.app_short_description"
                ...
                <b-col md="6">
                    ...
                    >
                        <v-select
                            ...
                            :placeholder="
                                $t('app_setting_theme_contrast_placeholder')
                            "
                        />
                    </b-form-group>
                </b-col>
                ...
                <b-col md="6">
                    ...
                    >
                        <v-select
                            ...
                            v-model="config.app_country_iso"
                            :clearable="false"
                        />
                    </b-form-group>
                </b-col>
