...
export default {
    ...
    methods: {
        async getAction() {
            try {
                this.loading = true;
                const { data } = await LaboratoryActionResource.getLaboratoryActionDetail(this.action_id);
                this.loading = false;
        ...
        async store() {
            try {
                this.loading = true;
                const { data } = await LaboratoryActionResource.update(this.action.id, this.action);
                this.loading = false;
                if (data.success) {
