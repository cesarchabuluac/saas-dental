                            ...
                            <b-card-body class="invoice-padding pt-0">
                                <b-row class="invoice-spacing">
                                    ...
                                    <b-col cols="12" xl="6" class="mb-lg-1">
                                        ...
                                        <!-- Warehouses -->
                                        <div class="mt-2">
                                            <label class="mb-50">Almacen</label>
                                            <v-select
                                                disabled
                                        ...
                                        <b-col cols="12">
                                            ...
                                            <div class="d-none d-lg-flex">
                                                <b-row class="flex-grow-1 px-1">
                                                    ...
                                                    <b-col cols="12" lg="6">Medicamento</b-col>
                                                    <b-col cols="12" lg="2">Stock</b-col>
                                                    <b-col cols="12" lg="2">Cant</b-col>
                                                    <b-col cols="12" lg="2">Tipo Ajuste</b-col>
                                                </b-row>
                                            ...
                                            <div class="d-flex border rounded">
                                                <b-row class="flex-grow-1 p-2">
                                                    <!-- Single Item Form Headers -->
                                                    <b-col cols="12" lg="6">
                                                        <label class="d-inline d-lg-none">Medicamento</label>
                                                        <b-form-input
                                                            v-model="item.name"
                                                            readonly
                                                        />
                                                    ...
                                                    <b-col cols="12" lg="2">
                                                        <label class="d-inline  d-lg-none">Stock</label>
                                                        <b-form-input v-model="item.stock" type="number" class="mb-2" disabled/>
                                                    </b-col>
                                                    <b-col cols="12" lg="2">
                                                        <label class="d-inline d-lg-none">Cant</label>
                                                        <b-form-input
                                                            disabled
                                                    ...
                                                    <b-col cols="12" lg="2">
                                                        <label class="d-inline d-lg-none">Tipo Ajuste</label>
                                                        <v-select
                                                            disabled
                                                            v-model="item.type"
                                                    ...
                                                    <b-col cols="12" lg="6">
                                                        <label class="d-inline d-lg-none">Comentarios</label>
                                                        <b-form-textarea
                                                            disabled
                                                            v-model="item.comment"
                                                            placeholder="Comentarios: Ejem. Se agotó el producto"/>
                                                    </b-col>
                                                </b-row>
                                            </div>
                                        </b-col>
                            ...
                            <b-card-body class="invoice-padding pb-0">
                                <b-row>
                                    ...
                                    <b-col cols="12" md="6" class="mt-md-0 mt-3 d-flex align-items-center" order="2" order-md="1">
                                        <b-card-body class="invoice-padding pt-0">
                                            <label for="invoice-data-sales-person" class="text-nowrap mr-50 font-weight-bold">Nota / Comentarios:</label>
                                    ...
                                    <b-col cols="12" md="6" class="mt-md-6 d-flex justify-content-end" order="1" order-md="2">
                                        <div class="invoice-total-wrapper">
                                            <div class="invoice-total-item">
                                                <b-button @click="$router.push({ name: 'apps-inventories-adjustments'})" v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="secondary" block>
                                                    Regresar a Ajustes
                                                </b-button>
                                            </div>
                                        </div>
...
export default {
    ...
    setup() {
        ...
        const getAdjustmentDetail = async (id) => {
            loading.value = true
            const { data } = await AdjustmentResource.show(id);
            loading.value = false
        ...
        onMounted(async () => {
            await getWarehouses()
            await getAdjustmentDetail(router.currentRoute.params.id)
        })
