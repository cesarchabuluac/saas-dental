...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      options: {
        profile: {
          avatar: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/avatar_default.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
          name: null,
          email: null,
          id: null
        }
  ...
  computed: {
    user: function user() {
      var data = _store__WEBPACK_IMPORTED_MODULE_4__["default"].state.auth.user;
      return this.options.profile = {
        avatar: data.has_media ? data.media[0].thumb : __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/avatar_default.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
        name: data.name,
        email: data.email,
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/providers/Users'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var UserResource = new !(function webpackMissingModule() { var e = new Error("Cannot find module '@/providers/Users'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
