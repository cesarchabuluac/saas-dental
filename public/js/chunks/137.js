...
/* harmony import */ var _fullcalendar_vue__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @fullcalendar/vue */ "./node_modules/@fullcalendar/vue/dist/main.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    isAdmin: function isAdmin() {
      return _store__WEBPACK_IMPORTED_MODULE_13__["default"].getters['auth/getRoleId'] === 1 || false;
    },
    isDirector: function isDirector() {
      return _store__WEBPACK_IMPORTED_MODULE_13__["default"].getters['auth/getRoleId'] === 2 || false;
    }
  },
  watch: {
    ...
    return Object(C_projects_saas_dental_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/Object(C_projects_saas_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().mark(function _callee() {
      return Object(C_projects_saas_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            console.error(_this.checkIsTenant());
            _context.next = 3;
  ...
  methods: {
    ...
    mapRoles: function mapRoles() {
      ...
      // if (this.isAdmin) {
      //     this.roleOptions = _.map(data, (element) => {
      //         return {
      //             id: element.id,
      ...
      //     })
      // } else {
      //     this.roleOptions = data.filter(d => d.id != 1).map((element) => {
      //         return {
      //             id: element.id,
      //             name: this.$t(`role_${element.name}`)
      //         }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      alphaNum: _validations__WEBPACK_IMPORTED_MODULE_12__["alphaNum"],
      email: _validations__WEBPACK_IMPORTED_MODULE_12__["email"],
      password: _validations__WEBPACK_IMPORTED_MODULE_12__["password"],
      clevePhone: {
        phone: true,
        phoneRegionCode: "US"
      },
  ...
  methods: {
    ...
    } // this.userData.role = value.map((role) => role.id);
  },
  setup: function setup(props, _ref) {
    ...
    var userData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])(JSON.parse(JSON.stringify(blankUserData)));
        ...
        return Object(C_projects_saas_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              loading.value = true;
              _context2.next = 4;
              return UserResource.store(Object(C_projects_saas_dental_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, userData.value));
            case 4:
            ...
            case 10:
              ...
              if (_context2.t0.response.status === 422) {
                errors = Object.values(_context2.t0.response.data.errors);
                errors = errors.flat();
                _data = {
                  success: false,
                  message: errors[0]
    ...
    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_13__["default"])(resetuserData),
