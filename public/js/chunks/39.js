    ...
    [
      _c("b-card", { attrs: { "no-body": "" } }, [
                ...
                _c(
                  ...
                  [
                    _c("h4", [
                      ...
                      _c("small", [
                        _c("br"),
                        _vm._v(_vm._s(_vm.$t("appointments.management_help"))),
                      ]),
                    ]),
                    _vm._v(" "),
                    _c(
        ...
        _c(
          ...
          {
            staticClass:
              "position-relative table-small text-small small b-table-sticky-header table-responsive",
          },
          [
            _c(
              "table",
              {
                staticClass:
                  "table b-table table-striped table-hover table-sm b-table-no-border-collapse",
                attrs: {
                  role: "table",
                  "aria-busy": "false",
                  "aria-colcount": "5",
              ...
              [
                ...
                _c(
                  ...
                  _vm._l(_vm.appointments, function (item, index) {
                    return _c(
                      "tr",
                      { key: index, attrs: { role: "row", id: item.id } },
                      [
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 1, role: "cell" },
                          },
                          [
                            _vm._v(
                              " " +
                                _vm._s(_vm.dateTimeFormat(item.date, "H:mm"))
                            ),
                          ]
                        ),
                        _vm._v(" "),
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 2, role: "cell" },
                          },
                          [
                            _c(
                              "b-media",
                              ...
                              [
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      "\n                                    " +
                                        _vm._s(item.patient.document_type) +
                                        ": " +
                                        _vm._s(item.patient.rut)
                                    ),
                                    _c("br"),
                                    _vm._v(" "),
                                    _c(
                        ...
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 3, role: "cell" },
                          },
                          [
                            _c(
                              "span",
                        ...
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 4, role: "cell" },
                          },
                          [
                            _c(
                              "b-badge",
                              ...
                              [
                                _vm._v(
                                  _vm._s(
                                    _vm.resolveStateAppointment(item.state)
                                  )
                                ),
                              ]
                            ),
                        ...
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 5, role: "cell" },
                          },
                          [
                            _c(
                              "div",
                                ...
                                item.state == "pending"
                                  ? _c(
                                      "b-button",
                                      {
                                        ...
                                        on: {
                                          click: function ($event) {
                                            return _vm.deleteAppointment(item)
                                          },
                                        },
                                      },
                                      [
                    ...
                    _c(
                      ...
                      [
                        _c("span", { staticClass: "text-muted" }, [
                          _vm._v(
                            _vm._s(_vm.resolvePaginationTranslate(_vm.dataMeta))
                          ),
                        ]),
                      ]
                    ),
      ...
      _c(
        ...
        [
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "d-sm-flex justify-content-between align-items-center _mb-3",
                    },
                    [
          ...
          _c(
            ...
            {
              staticClass:
                "position-relative b-table-responsive table-small small text-small b-table-sticky-header table-responsive",
            },
            [
              _c(
                "table",
                {
                  staticClass:
                    "table b-table table-sm b-table-no-border-collapse",
                  attrs: {
                    role: "table",
                    "aria-busy": "false",
                    "aria-colcount": "7",
                ...
                [
                  ...
                  _c(
                    "tbody",
                    { attrs: { role: "rowgroup" } },
                    _vm._l(_vm.professionals, function (item, index) {
                      return _c("tr", { key: index, attrs: { role: "row" } }, [
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 1, role: "cell" },
                        ...
                        _c(
                          ...
                          [_vm._v(_vm._s(item.assisted))]
                        ),
                        _vm._v(" "),
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 6, role: "cell" },
                          },
                          [_vm._v(_vm._s(item.unassisted))]
                        ),
                        _vm._v(" "),
                        _c(
                          "td",
                          {
                            attrs: { "aria-colindex": index + 7, role: "cell" },
                          },
                          [_vm._v(_vm._s(item.canceled))]
                        ),
                      ])
                    }),
                    0
