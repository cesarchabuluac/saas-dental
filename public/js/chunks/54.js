  ...
  methods: {
        ...
        return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _this3.professionals = data.data;
            case 8:
            case "end":
    ...
    updateTable: function updateTable() {
      ...
      this.selectedClinicalActions.filter(function (action) {
        ...
        if (_this4.remainingIncome === 0) {
          action.assigned_income = 0;
        } else if (_this4.remainingIncome >= action.debt) {
          action.assigned_income = action.debt;
          _this4.remainingIncome -= action.debt;
        } else {
          action.assigned_income = _this4.remainingIncome;
          _this4.remainingIncome = 0;
        }
        return action;
      });
      this.selectedLaboratoryActions.filter(function (action) {
        ...
        if (_this4.remainingIncome === 0) action.assigned_income = 0;else if (_this4.remainingIncome >= action.debt) {
          action.assigned_income = action.debt;
          _this4.remainingIncome -= action.debt;
        } else {
          action.assigned_income = _this4.remainingIncome;
      ...
      return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().mark(function _callee4() {
        ...
        return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              payload = {
                budget_id: _this5.budget.id,
                amount: _this5.totalIncome,
                clinical_actions: _this5.selectedClinicalActions.filter(function (action) {
                  return action.debt > 0;
                }).flat(),
                laboratory_actions: _this5.selectedLaboratoryActions.filter(function (action) {
                  return action.debt > 0;
                }).flat(),
                payment_method: _this5.paymentMethod,
                positive_balance: _this5.remainingIncome,
                type: _this5.paymentType,
                payments_number: _this5.paymentsNumber,
                check: _this5.check,
                total_action: _this5.totalClinicalActions + _this5.totalLaboratoryActions
              };
              if (!(payload.laboratory_actions.length === 0 && payload.clinical_actions.length === 0)) {
                _context4.next = 4;
                break;
              }
              _this5.danger(_this5.$t('charges.required_actions'));
              return _context4.abrupt("return", false);
            case 4:
              if (!(_this5.totalIncome <= 0)) {
                _context4.next = 7;
                break;
              }
              _this5.danger(_this5.$t('charges.valid_quantity'));
              return _context4.abrupt("return", false);
            case 7:
              _iterator = Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_this5.selectedClinicalActions);
              _context4.prev = 8;
              _iterator.s();
            case 10:
              ...
              _this5.danger(_this5.$t('charges.required_user'));
              return _context4.abrupt("return", false);
            case 15:
              _context4.next = 10;
              break;
            ...
            case 25:
              if (!((_this5.paymentMethod.value === "check" || _this5.paymentMethod.value === "transfer") && !_this5.checkInfoStored)) {
                _context4.next = 28;
                break;
              }
              _this5.checkModalActive = true;
              return _context4.abrupt("return", false);
            case 28:
              _context4.prev = 28;
              _this5.loading = true;
            ...
            case 32:
              _yield$PaymentResourc = _context4.sent;
              ...
              _this5.budget = data.data.budget;
              _this5.payment = data.data.payment;
              if (!(_this5.paymentType.value == 3)) {
                _context4.next = 46;
                break;
              }
              _this5.paymentTypes[0].disabled = !_this5.payment.has_partials;
              _this5.paymentTypes[1].disabled = !_this5.payment_has_partials;
              _.map(_this5.budget.budget_actions, function (item, index) {
                item.is_selected = true;
                _this5.$set(item, '_showDetails', true);
              });
              _this5.success(_this5.$t('charges.deferred_successfully'));
              return _context4.abrupt("return", false);
            case 46:
              _this5.success(_this5.$t('charges.successfully'));
              _this5.$router.push({
                name: "payments-budgets-preview",
                params: {
                  id: _this5.budget.id,
                  payment_id: _this5.payment.id,
            ...
            case 54:
              ...
              _this5.loading = false;
              if (!(_this5.paymentMethod.value === "check" || _this5.paymentMethod.value === "transfer")) {
                _context4.next = 60;
                break;
              }
              _this5.checkModalActive = true;
              return _context4.abrupt("return", false);
            case 60:
              _this5.handleResponseErrors(_context4.t1);
            case 61:
            case "end":
              return _context4.stop();
          }
        }, _callee4, null, [[8, 19, 22, 25], [28, 54]]);
      }))();
    },
      ...
      return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().mark(function _callee5() {
        ...
        return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 8:
              _yield$PaymentResourc2 = _context5.sent;
    ...
    expandAll: function expandAll() {
      var _iterator2 = Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.clinicalActions),
        _step2;
      try {
    ...
    collapseAl: function collapseAl() {
      var _iterator3 = Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.clinicalActions),
        _step3;
      try {
        ...
        case 2:
          ...
          this.clinicalActions = this.clinicalActions.map(function (action) {
            if (action.debt === 0) {
              ...
              _this7.$set(action, '_showDetails', true);
            } else {
...
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./node_modules/sass-loader/dist/cjs.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/apps/payments/payment-charge/Charge.vue?vue&type=style&index=0&id=262a5e49&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Charge.vue?vue&type=style&index=0&id=262a5e49&lang=scss& */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/apps/payments/payment-charge/Charge.vue?vue&type=style&index=0&id=262a5e49&lang=scss&");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Charge_vue_vue_type_style_index_0_id_262a5e49_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/style-loader!../../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Charge.vue?vue&type=style&index=0&id=262a5e49&lang=scss& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/apps/payments/payment-charge/Charge.vue?vue&type=style&index=0&id=262a5e49&lang=scss&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Charge_vue_vue_type_style_index_0_id_262a5e49_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Charge_vue_vue_type_style_index_0_id_262a5e49_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Charge_vue_vue_type_style_index_0_id_262a5e49_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Charge_vue_vue_type_style_index_0_id_262a5e49_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
