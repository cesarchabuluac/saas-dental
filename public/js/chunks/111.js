...
/* harmony import */ var D_projects_dental_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    Cleave: vue_cleave_component__WEBPACK_IMPORTED_MODULE_19___default.a,
  ...
  data: function data() {
    ...
    return _ref = {
    ...
    }, Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, "loading", false), Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, "isChangeAvatar", false), Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, "roles", []), Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, "days", [{
      ...
      value: 6
    }]), Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, "schedules", []), Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, "selectedDays", []), _ref;
  },
  computed: {
    ...
    isAdmin: function isAdmin() {
      return _store__WEBPACK_IMPORTED_MODULE_21__["default"].state.auth.user.roles[0].id === 1 || false;
    }
  },
  created: function created() {
    if (_store__WEBPACK_IMPORTED_MODULE_21__["default"].state.auth.setting['language'] === "es") {
  ...
  methods: {
        ...
        return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _this2.loading = true;
              _context2.next = 3;
              return UserResource.getUserDetail(_router__WEBPACK_IMPORTED_MODULE_20__["default"].currentRoute.params.id);
            case 3:
              _yield$UserResource$g = _context2.sent;
              data = _yield$UserResource$g.data;
              _this2.loading = false;
              _this2.user = data.data;
              _this2.avatar = _this2.user.has_media ? _this2.user.avatar : _this2.avatarDefault;
              _this2.user.role_id = _this2.user.roles[0].id;
              _this2.role_id = _this2.user.role_id;
              _this2.schedules = _this2.user.schedules;
              _this2.schedules.map(function (item) {
                return _this2.selectedDays.push(item.day_of_week);
              });
            case 12:
            case "end":
    ...
    update: function update() {
      ...
      return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().mark(function _callee3() {
        var isOkTimeDetail, _yield$UserResource$u, data;
        return Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_1__["default"])().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _this3.user.role_id = _this3.role_id;
              if (!(_this3.user.role_id === 4)) {
                _context3.next = 7;
                break;
              }
              isOkTimeDetail = _this3.schedules.some(function (item) {
                var isValid = item.start_time === null || item.start_time == "" || item.end_time === null || item.end_time == "";
                return isValid;
              });
              if (!isOkTimeDetail) {
                _context3.next = 6;
              ...
              _this3.danger(_this3.$t('days.error_days'));
              return _context3.abrupt("return", false);
            case 6:
              _this3.user.schedules = _this3.schedules.map(function (item) {
                return {
                  id: item.id || null,
                  day: item.day,
            ...
            case 7:
              ...
              _this3.loading = true;
              _context3.next = 11;
              return UserResource.update(_this3.user.id, _this3.user);
            case 11:
              _yield$UserResource$u = _context3.sent;
              data = _yield$UserResource$u.data;
              _this3.loading = false;
              if (data.success) {
                _this3.success(data.message);
                _router__WEBPACK_IMPORTED_MODULE_20__["default"].push({
                  name: "settings-users"
                });
              } else {
    ...
    mapRoles: function mapRoles() {
      var data = _store__WEBPACK_IMPORTED_MODULE_21__["default"].getters['auth/getRoles'];
      if (this.isAdmin) {
        ...
        this.roles = _.filter(data, function (element) {
          return element.id !== 1;
    ...
    inputImageRenderer: function inputImageRenderer(evt) {
      ...
      reader.onload = function (data) {
        ...
        _this4.user.change_avatar = true;
        _this4.user.avatar = res.result;
    ...
    updateSchedules: function updateSchedules() {
      var _this5 = this;
      // Crear una copia del arreglo "selectedDays" para que no se modifique directamente
      var selectedDaysCopy = Object(D_projects_dental_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.selectedDays);
      ...
      this.schedules = this.schedules.filter(function (schedule) {
        var index = selectedDaysCopy.indexOf(schedule.day_of_week);
        if (index !== -1) {
      ...
      selectedDaysCopy.forEach(function (dayOfWeek) {
        var exists = _this5.schedules.some(function (schedule) {
          return schedule.day_of_week === dayOfWeek;
        });
        if (!exists) {
          var day = _this5.days.find(function (day) {
            return day.value === dayOfWeek;
          });
          if (day) {
            _this5.schedules.push({
              day: day.text,
              day_of_week: day.value,
              start_time: _store__WEBPACK_IMPORTED_MODULE_21__["default"].getters['auth/getSettings'].schedule_start_time,
              // Puedes configurar el valor inicial aquí
              end_time: _store__WEBPACK_IMPORTED_MODULE_21__["default"].getters['auth/getSettings'].schedule_end_time // Puedes configurar el valor inicial aquí
            });
          }
        }
      });
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/settings/users/Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./node_modules/sass-loader/dist/cjs.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/settings/users/Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/settings/users/Edit.vue?vue&type=template&id=7d6d6fa3&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/settings/users/Edit.vue?vue&type=template&id=7d6d6fa3& ***!
  \*********************************************************************************************************************************************************************************************************************/
                              ...
                              return [
                                _c("b-avatar", {
                                  ...
                                  attrs: {
                                    ...
                                    variant:
                                      "light-" +
                                      _vm.resolveRoleVariant(_vm.user.roles),
                                    size: "90px",
                                    rounded: "",
                                  },
                                }),
                              ...
                              ? _c(
                                  ...
                                  [
                                    _c(
                                      ...
                                      {
                                        attrs: {
                                          label: _vm.$t("work_days"),
                                          description: _vm.$t("work_days_help"),
                                        },
                                      },
                                      [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Edit_vue_vue_type_template_id_7d6d6fa3___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Edit.vue?vue&type=template&id=7d6d6fa3& */ "./resources/js/src/views/settings/users/Edit.vue?vue&type=template&id=7d6d6fa3&");
/* harmony import */ var _Edit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit.vue?vue&type=script&lang=js& */ "./resources/js/src/views/settings/users/Edit.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _Edit_vue_vue_type_style_index_0_id_7d6d6fa3_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss& */ "./resources/js/src/views/settings/users/Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Edit_vue_vue_type_template_id_7d6d6fa3___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Edit_vue_vue_type_template_id_7d6d6fa3___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "./resources/js/src/views/settings/users/Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/src/views/settings/users/Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss& ***!
  \******************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_7d6d6fa3_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader!../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/settings/users/Edit.vue?vue&type=style&index=0&id=7d6d6fa3&lang=scss&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_7d6d6fa3_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_7d6d6fa3_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_7d6d6fa3_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_style_index_0_id_7d6d6fa3_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/src/views/settings/users/Edit.vue?vue&type=template&id=7d6d6fa3&":
/*!***************************************************************************************!*\
  !*** ./resources/js/src/views/settings/users/Edit.vue?vue&type=template&id=7d6d6fa3& ***!
  \***************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_7d6d6fa3___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Edit.vue?vue&type=template&id=7d6d6fa3& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/settings/users/Edit.vue?vue&type=template&id=7d6d6fa3&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_7d6d6fa3___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_7d6d6fa3___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
