...
/* harmony default export */ __webpack_exports__["default"] = ({
  directives: {
    ...
    "b-tooltip": bootstrap_vue__WEBPACK_IMPORTED_MODULE_15__["VBTooltip"]
  },
  components: {
    ...
    BTooltip: bootstrap_vue__WEBPACK_IMPORTED_MODULE_15__["BTooltip"],
    VBTooltip: bootstrap_vue__WEBPACK_IMPORTED_MODULE_15__["VBTooltip"]
  },
  ...
  return _c(
    ...
    [
                                                    ...
                                                    "b-button",
                                                    {
                                                      ...
                                                      on: {
                                                        click: function (
                                                          ...
                                                          _vm.isAddNewPatientSidebarActive = true
                                                        },
                                                      },
                                                    },
                                                    [
      ...
      _c("sidebar-add-new-patient", {
        attrs: {
          "is-add-new-patient-sidebar-active": _vm.isAddNewPatientSidebarActive,
          data: _vm.patient,
          isValidCellPhone: _vm.isValidCellPhone,
          loading: _vm.loading,
        },
        on: {
          "update:isAddNewPatientSidebarActive": function ($event) {
            _vm.isAddNewPatientSidebarActive = $event
          },
          "update:is-add-new-patient-sidebar-active": function ($event) {
            _vm.isAddNewPatientSidebarActive = $event
          },
          store: _vm.storePatient,
        },
      }),
      _vm._v(" "),
      _c(
