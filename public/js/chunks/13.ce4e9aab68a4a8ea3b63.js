...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    console.log(_store_index__WEBPACK_IMPORTED_MODULE_7__["default"].state);
  },
  methods: {
    validationForm: function validationForm() {
      ...
      this.$refs.loginValidation.validate().then(function (success) {
        if (success) {
          ...
          _this.loading = true;
          _store_index__WEBPACK_IMPORTED_MODULE_7__["default"].dispatch("auth/GET_AUTH_TOKEN", payload).then(function () {
            var user = _store_index__WEBPACK_IMPORTED_MODULE_7__["default"].getters['auth/getUser'];
            _this.success("Bienvenido ".concat(user.name));
