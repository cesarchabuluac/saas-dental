    ...
    validationForm: function validationForm() {
      ...
      this.$refs.loginValidation.validate().then(function (success) {
        if (success) {
          ...
          _this.loading = true;
          _store_index__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("auth/GET_AUTH_TOKEN", payload).then(function () {
            var user = _store_index__WEBPACK_IMPORTED_MODULE_5__["default"].getters['auth/getUser'];
            console.log(user);
            // this.success(`${this.__('lang.welcome')} ${user.name}`);
