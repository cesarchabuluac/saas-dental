...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('plans', function (Blueprint $table) {
            ...
            $table->integer('limit_doctor')->default(0)->comment('0 means unlimited');
            $table->integer('limit_assistant')->default(0)->comment('0 means unlimited');
            $table->integer('limit_receptionist')->default(0)->comment('0 means unlimited');
            $table->integer('limit_patient')->default(0)->comment('0 means unlimited');
