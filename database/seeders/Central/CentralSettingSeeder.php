...
class CentralSettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        GeneralSetting::query()->firstOrCreate(['key' => 'register_tenant_mailjet_template_id', 'value' => '5063364']);
        GeneralSetting::query()->firstOrCreate(['key' => 'trials_end_tenant_mailjet_template_id', 'value' => '5063397']);
        GeneralSetting::query()->firstOrCreate(['key' => 'invoice_reminder_tenant_mailjet_template_id', 'value' => '5063404']);
