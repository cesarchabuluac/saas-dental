...
class VerificationController extends Controller
{
    ...
    public function verify(Request $request, Tenant $tenant, TenantService $tenantService)
    {
        if (! URL::hasValidSignature($request)) {
            ...
            // return $this->sendError("The verification link is invalid.", 201);
        ...
        if ($tenant->hasVerifiedEmail()) {
            ...
            // ];
            // return $this->sendResponse($data, "The email is already verified.");
        ...
        // $data = [
        //     'domain' => $domainWithHostAndToken['domainWithHost'],
        //     'token' => $domainWithHostAndToken['token']
        // ];
        // return $this->sendResponse($domainWithHostAndToken, "111 Your email has been verified!");
