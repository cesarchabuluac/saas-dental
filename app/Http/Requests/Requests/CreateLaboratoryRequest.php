...
class CreateLaboratoryRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|min:3|unique:laboratories,name',
    ...
    public function messages()
    {
        return [
            ...
            'rut.required' => 'El document es requerido',
            'rut.min' => 'El document debe tener al menos 9 caracteres',
            'rut.max' => 'El document debe tener máximo 50 caracteres',
            'rut.unique' => 'El document ya está en uso',
